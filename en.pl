...
'Medium algorithm' => 'Medium algorithm',
'Weak algorithm' => 'Weak algorithm (insecure)',
...
'ccd lz4' => 'LZ4-v2-Compression:',
'ccd modify' => 'Change network',
'ccd name' => 'Name',
'ccd ncp' => 'Disable cipher negotiation:',
...
'ovpn keylenghthost' => 'Host CA keylenght',
'ovpn keylenghtroot' => 'Root CA keylenght',
'ovpn log' => 'OVPN-Log',
...
'ovpn ncp' => 'Automatic cipher negotiation:',
...
'tc key is missing' => 'The tc.key for tls-crypt is missing, please import it first from the TLS-Server',
