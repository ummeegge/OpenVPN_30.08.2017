...
'Strong algorithm' => 'Starker Algorithmus',
'Medium algorithm' => 'Durchschnittlicher Algorithmus',
'Weak algorithm' => 'Schwacher Algorithmus (unsicher)',
...
'ccd name' => 'Name',
'ccd ncp' => 'Deativiere aushandeln der Verschlüsselung:',
...
'ovpn keylenghthost' => 'Host CA Schlüssellänge',
'ovpn keylenghtroot' => 'Root CA Schlüssellänge',
'ovpn log' => 'OVPN-Log',
...
'ovpn ncp' => 'Verschlüsselung automatisch aushandeln:',
...
'tc key is missing' => 'Der tc.key für tls-crypt is nicht vorhanden, bitte zuerst vom TLS-Server importieren.',
